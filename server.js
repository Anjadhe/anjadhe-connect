...
const ADMIN_PAGES = { '': 'overview', overview: 'overview', analytics: 'analytics', website: 'website', installs: 'installs', feedback: 'feedback', subscribers: 'subscribers', licenses: 'licenses', models: 'models' };
