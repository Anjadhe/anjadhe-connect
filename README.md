...
| `GET /admin` | Operator pages (browser; enter `ADMIN_TOKEN` in the page). `/admin` is service health; `/admin/analytics`, `/admin/installs`, `/admin/feedback`, `/admin/subscribers`, `/admin/licenses` and `/admin/models` are its siblings. |
