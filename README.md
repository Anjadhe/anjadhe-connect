...
route answers per topic — a request is a 200 even when every topic inside
it failed, and the app backfills those topics from the user's own Mac. Set `ALERT_WEBHOOK_URL` (Slack/Discord webhook or an ntfy.sh
